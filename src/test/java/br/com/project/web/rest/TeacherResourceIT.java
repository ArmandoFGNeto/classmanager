...
public class TeacherResourceIT {
    ...
    private static final BigDecimal SMALLER_PAYMENT = new BigDecimal(1 - 1);
    ...
    public void createTeacher() throws Exception {
        ...
        assertThat(testTeacher.getPayment()).isEqualTo(DEFAULT_PAYMENT);
    }
    ...
    public void updateTeacher() throws Exception {
        ...
        assertThat(testTeacher.getPayment()).isEqualTo(UPDATED_PAYMENT);
    }
