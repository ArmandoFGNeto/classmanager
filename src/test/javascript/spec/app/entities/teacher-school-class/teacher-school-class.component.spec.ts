...
import { TeacherSchoolClassComponent } from 'app/entities/teacher-school-class/teacher-school-class.component';
...
describe('Component Tests', () => {
  describe('TeacherSchoolClass Management Component', () => {
    let comp: TeacherSchoolClassComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TeacherSchoolClassComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new TeacherSchoolClass(123)],
            headers
          })
        )
      );
