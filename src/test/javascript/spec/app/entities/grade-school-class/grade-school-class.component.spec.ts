...
import { GradeSchoolClassComponent } from 'app/entities/grade-school-class/grade-school-class.component';
...
describe('Component Tests', () => {
  describe('GradeSchoolClass Management Component', () => {
    let comp: GradeSchoolClassComponent;
    let fixture: ComponentFixture<GradeSchoolClassComponent>;
    let service: GradeSchoolClassService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ClassmanagerTestModule],
        declarations: [GradeSchoolClassComponent],
        providers: [
          {
        ...
        .overrideTemplate(GradeSchoolClassComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(GradeSchoolClassComponent);
