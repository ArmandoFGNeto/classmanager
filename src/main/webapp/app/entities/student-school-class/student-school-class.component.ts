...
@Component({
  selector: 'jhi-student-school-class',
  templateUrl: './student-school-class.component.html'
})
export class StudentSchoolClassComponent implements OnInit, OnDestroy {
  currentAccount: any;
  ...
  loadAll() {
    this.studentService
      ...
      .subscribe(
        (res: HttpResponse<IStudentSchoolClass[]>) => this.paginateStudents(res.body, res.headers),
  ...
  transition() {
    this.router.navigate(['/student-school-class'], {
      queryParams: {
        page: this.page,
        size: this.itemsPerPage,
  ...
  trackId(index: number, item: IStudentSchoolClass) {
    return item.id;
  }
  ...
  protected paginateStudents(data: IStudentSchoolClass[], headers: HttpHeaders) {
